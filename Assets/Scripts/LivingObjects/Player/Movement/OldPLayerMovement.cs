...
//    [SerializeField] float airControl = 20;


//    private float calculatedGroundCheckLenght;

//    [HideInInspector] public bool onGround = false;
//    [SerializeField] float landingBounceAmount;
...
//        else
//        {
//            rigidBody.velocity += new Vector2(velocityToAddX * Time.deltaTime * 5, 0);
//        }
...
//    {
//        transform.rotation = Quaternion.Euler(0, 0, -veloX * (5 - timeActive) * 0.5f);
//    }
//    private void Jump()
//    {
